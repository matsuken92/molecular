...
from keras.layers import Dense, BatchNormalization, Dropout, Input, Reshape, Concatenate
...
if MODEL_TYPE == "lgb":
    ...
    for leaves in leaves_list:
        ...
        score_list = train_lgb(X, y, seed, params, eval_metric, model_type=MODEL_TYPE)
