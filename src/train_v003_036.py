...
if False:
    ...
    train = unpickle(save_path/f"v003_033/train_concat_v003_033.pkl", )
    test = unpickle(save_path/f"v003_033/test_concat_v003_033.pkl", )
...
X = train[use_cols_revised].copy()
y = train['scalar_coupling_constant']
y_fc = train['fc']
X_test = test[use_cols_revised].copy()
...
#########################################################################################################
# 1st layer model
seed_base = [2019, 71, 1228, 1988, 1879, 92, 3018, 1234, 185289]
#seed_base = [0, 2019, 71, 1228, 1988, 1879, 92, 3018, 1234, 185289]
seed_list = np.array(seed_base) + 20
#seed_list = np.array(seed_base) + 21
#seed_list = np.array(seed_base) + 22
#seed_list = np.array(seed_base) + 23
#seed_list = np.array(seed_base) + 24
...
for seed in seed_list:
    ...
    if seed==current_seed:
        X_short_test = pd.read_csv(submit_path/f"tmp_oof_6.csv")
    else:
