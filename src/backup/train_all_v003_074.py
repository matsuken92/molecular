...
#seed_base = [2019]
seed_list = np.array(seed_base) + 150
#seed_list = np.array(seed_base) + 151
#seed_list = np.array(seed_base) + 152
#seed_list = np.array(seed_base) + 153
#seed_list = np.array(seed_base) + 154
