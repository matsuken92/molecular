...
del seg_submolecule_fp_maccs_train
del seg_submolecule_fp_maccs_test
...
mol_type_dist_feat_train = unpickle("../processed/v003/mol_type_dist_feat_train.pkl")
mol_type_dist_feat_test = unpickle("../processed/v003/mol_type_dist_feat_test.pkl")
train = pd.concat([train, mol_type_dist_feat_train], axis=1)
test  = pd.concat([test, mol_type_dist_feat_test], axis=1)
del mol_type_dist_feat_train
del mol_type_dist_feat_test
assert len(train) == 4658147
assert len(test)  == 2505542
