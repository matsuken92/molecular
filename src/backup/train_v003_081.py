...
dist_feat_train = unpickle("../processed/v003/dist_feat_df_train.pkl")
dist_feat_test  = unpickle("../processed/v003/dist_feat_df_test.pkl")
train = pd.concat([train, dist_feat_train], axis=1)
test = pd.concat([test, dist_feat_test], axis=1)

print("dist_feat loaded.")
#
...
#
# seg_H2J_stats_feat2_train = unpickle("../processed/v003/seg_H2J_stats_feat2_train.pkl").astype(float)
# seg_H3J_stats_feat2_train = unpickle("../processed/v003/seg_H3J_stats_feat2_train.pkl").astype(float)
# seg_H2J_stats_feat2_test  = unpickle("../processed/v003/seg_H2J_stats_feat2_test.pkl").astype(float)
# seg_H3J_stats_feat2_test  = unpickle("../processed/v003/seg_H3J_stats_feat2_test.pkl").astype(float)
#
# train = pd.concat([train, seg_H2J_stats_feat2_train, seg_H3J_stats_feat2_train], axis=1)
# test = pd.concat([test, seg_H2J_stats_feat2_test, seg_H3J_stats_feat2_test], axis=1)
#
# prev_folder = "../processed/v003/v003_075/"
# prev_data_version  = "v003"
# prev_trial_no = "075"
# Path(prev_folder).mkdir(parents=True, exist_ok=True)
# to_pickle(f"{prev_folder}train_concat_{prev_data_version}_{prev_trial_no}_yiemon_123J_HnJ_H23J.pkl", train)
# to_pickle(f"{prev_folder}test_concat_{prev_data_version}_{prev_trial_no}_yiemon_123J_HnJ_H23J.pkl", test)
