#!/home/kenichi.matsui/anaconda3/envs/kaggle_3.6/bin/python
# coding: utf-8
...
for seed in seed_list:
    ...
    if not USE_PREV_1st_MODEL:
        ...
        if not FC_SKIP:
            ...
            X['oof_fc'] = unpickle(submit_path/"train_oof_fc_v003_056_50.pkl")
            X_test['oof_fc'] = unpickle(submit_path/"test_oof_fc_v003_056_50.pkl")
        ...
        if True:
            X['oof_mullkan_0'] =  unpickle(submit_path / f"train_oof_mullkan_0_{DATA_VERSION}_{TRIAL_NO}_{seed}.pkl", )
            X_test['oof_mullkan_0'] = unpickle(submit_path / f"test_oof_mullkan_0_{DATA_VERSION}_{TRIAL_NO}_{seed}.pkl", )
            X['oof_mullkan_1'] =  unpickle(submit_path / f"train_oof_mullkan_1_{DATA_VERSION}_{TRIAL_NO}_{seed}.pkl", )
            X_test['oof_mullkan_1'] = unpickle(submit_path / f"test_oof_mullkan_1_{DATA_VERSION}_{TRIAL_NO}_{seed}.pkl", )
