...
remove_cols =['2J1st_IsPolarHydrogen', '2J2nd_IsAxial', '2J2nd_MemberOfRingSize',
       '2J2nd__C', '2J2nd__N', '2J2nd__O', '2J2nd__nan', '2J2nd_isAroma',
       '2J2nd_isChiral', '2Jlast_IsPolarHydrogen', 'C', 'C_ratio_H',
       'C_ratio_all', 'F_ratio_H', 'F_ratio_all', 'H', 'H_ratio_H',
       'H_ratio_all', 'N', 'N_ratio_H', 'N_ratio_all', 'O', 'O_ratio_H',
       'O_ratio_all', 'Torsion', 'a0_nb_degree', 'a0_nb_inring6',
       'a0_nb_inring7', 'a0_nb_inring8', 'a0_nb_nb_c', 'a0_nb_nb_h',
       'a0_nb_nb_na', 'a1_inring', 'a1_inring6', 'a1_inring7',
       'a1_inring8', 'a1_nb_c', 'a1_nb_degree', 'a1_nb_h',
       'a1_nb_hybridization', 'a1_nb_inring', 'a1_nb_inring3',
       'a1_nb_inring4', 'a1_nb_inring5', 'a1_nb_inring6', 'a1_nb_inring7',
       'a1_nb_inring8', 'a1_nb_n', 'a1_nb_na', 'a1_nb_nb_c', 'a1_nb_nb_h',
       'a1_nb_nb_n', 'a1_nb_nb_na', 'a1_nb_nb_o', 'abs_dist', 'atm_d_var',
       'atm_dist_max_all_0', 'atm_dist_max_all_diff',
       'atm_dist_max_all_of_nn', 'atm_dist_max_all_ratio',
       'atm_dist_mean_all_0', 'atm_dist_mean_all_diff',
       'atm_dist_mean_all_of_nn', 'atm_dist_mean_all_ratio',
       'atm_dist_min_all_diff', 'atm_dist_min_all_ratio',
       'atm_dist_var_all_0', 'atm_dist_var_all_diff',
       'atm_dist_var_all_of_nn', 'atm_dist_var_all_ratio',
       'atom_0_couples_count', 'atom_1_couples_count', 'atom_index_0',
       'atom_index_1', 'd_diff_0_all_comb_max', 'd_diff_0_all_comb_mean',
       ...
       'd_ratio_0_all_comb_mean', 'd_ratio_0_all_comb_var', 'dist_F_0_x',
       'dist_F_0_y', 'dist_F_1_x', 'dist_F_1_y', 'dist_H_3_x',
       'dist_H_4_x', 'dist_N_1_y', 'dist_N_2_x', 'dist_N_2_y',
       'dist_N_3_x', 'dist_N_3_y', 'dist_N_4_x', 'dist_N_4_y',
       'dist_O_2_x', 'dist_O_2_y', 'dist_O_3_x', 'dist_O_3_y', 'dist_xy',
       'dist_xz', 'dist_yz', 'eem2015ba_0', 'eem2015ba_diff',
       'eem2015ba_max', 'eem2015ba_max_min_ratio', 'eem2015ba_min',
       'eem2015ba_ratio', 'eem2015bm_diff', 'eem2015bm_max',
       'eem2015bm_max_min_ratio', 'eem2015bm_min', 'eem2015bm_ratio',
       'eem2015bn_0', 'eem2015bn_diff', 'eem2015bn_max',
       'eem2015bn_max_min_ratio', 'eem2015bn_min', 'eem2015bn_ratio',
       'eem2015ha_0', 'eem2015ha_diff', 'eem2015ha_max',
       'eem2015ha_max_min_ratio', 'eem2015ha_min', 'eem2015ha_ratio',
       'eem2015hm_0', 'eem2015hm_diff', 'eem2015hm_max',
       'eem2015hm_max_min_ratio', 'eem2015hm_min', 'eem2015hm_ratio',
       'eem2015hn_0', 'eem2015hn_1', 'eem2015hn_diff', 'eem2015hn_max',
       'eem2015hn_max_min_ratio', 'eem2015hn_min', 'eem2015hn_ratio',
       'eem_diff', 'eem_max', 'eem_max_min_ratio', 'eem_min', 'eem_ratio',
       'f004:angle', 'f004:angle_abs', 'f006:dist_from_origin_0',
       'f006:dist_origin_mean', 'gasteiger_diff', 'gasteiger_max',
       'gasteiger_min', 'gasteiger_ratio', 'inM_atm1_atm_d_var',
       'inM_atm_d_var', 'inM_d_max_diff', 'inM_d_mean_diff',
       'inM_d_mean_ratio', 'inM_d_min_diff', 'inM_max_min_diff',
       'inM_type_atm_d_count', 'inM_type_atm_d_var', 'mmff94_diff',
       'mmff94_max', 'mmff94_max_min_ratio', 'mmff94_min', 'mmff94_ratio',
       'molecule_atom_1_dist_mean', 'molecule_atom_index_0_dist_std',
       'molecule_atom_index_0_x_1_std',
       'molecule_atom_index_0_y_1_max_diff',
       'molecule_atom_index_0_y_1_mean_diff',
       'molecule_atom_index_0_y_1_mean_div',
       ...
       'molecule_atom_index_1_dist_mean',
       'molecule_atom_index_1_dist_std',
       'molecule_atom_index_1_dist_std_div', 'molecule_couples',
       'molecule_dist_max', 'molecule_dist_mean',
       'molecule_type_dist_mean_div', 'nn__C', 'nn__F', 'nn__H', 'nn__N',
       'nn__O', 'qeq_diff', 'qeq_max', 'qeq_max_min_ratio', 'qeq_min',
       'qeq_ratio', 'qtpie_diff', 'qtpie_max', 'qtpie_max_min_ratio',
       'qtpie_min', 'qtpie_ratio', 'tda_min_radius', 'total_atm_num',
       'x_0', 'x_1', 'x_a0_nb', 'x_a1_nb', 'x_max_diff_ho_inM_0',
       'x_max_diff_ho_inM_1', 'x_max_ho_inM_0', 'x_max_ho_inM_1',
       'x_max_ho_inM_ratio_0', 'x_max_ho_inM_ratio_1',
       ...
       'x_var_ho_inM_1', 'y_0', 'y_1', 'y_a0_nb', 'y_a1_nb',
       'y_max_diff_ho_inM_0', 'y_max_diff_ho_inM_1', 'y_max_ho_inM_0',
       'y_max_ho_inM_1', 'y_max_ho_inM_ratio_0', 'y_max_ho_inM_ratio_1',
       'y_mean_diff_ho_inM_0', 'y_mean_diff_ho_inM_1', 'y_mean_ho_inM_0',
       'y_mean_ho_inM_1', 'y_mean_ho_inM_ratio_0',
       'y_mean_ho_inM_ratio_1', 'y_min_diff_ho_inM_0',
       'y_min_diff_ho_inM_1', 'y_min_ho_inM_0', 'y_min_ho_inM_1',
       'y_min_ho_inM_ratio_0', 'y_min_ho_inM_ratio_1', 'y_var_ho_inM_0',
       'y_var_ho_inM_1', 'z_0', 'z_1', 'z_a0_nb', 'z_a1_nb',
       'z_max_diff_ho_inM_0', 'z_max_diff_ho_inM_1', 'z_max_ho_inM_0',
       'z_max_ho_inM_1', 'z_max_ho_inM_ratio_0', 'z_max_ho_inM_ratio_1',
