...
for seed in seed_list:
    ...
    if not USE_PREV_1st_MODEL:
        ...
        X['oof_fc'] = unpickle("../submit/v003_071/train_oof_fc_v003_071_2069.pkl")
        X_test['oof_fc'] = unpickle("../submit/v003_071/test_oof_fc_v003_071_2069.pkl")
