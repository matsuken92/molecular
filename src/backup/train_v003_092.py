...
print("start loading comp_molvec_df_10")
mol_vec_df = unpickle("../processed/v003/comp_molvec_df_10.pkl", )
train = train.merge(mol_vec_df, on="molecule_name", how="left")
print(f"train.shape: {train.shape}")
test = test.merge(mol_vec_df, on="molecule_name", how="left")
print(f"test.shape: {test.shape}")
print("finished loading comp_molvec_df_10")
