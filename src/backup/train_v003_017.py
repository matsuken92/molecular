...
'dist_O_4_x', 'dist_F_0_x', 'dist_F_1_x', 'dist_F_2_x', 'dist_F_3_x',
'dist_F_4_x', 'dist_H_0_y', 'dist_H_1_y', 'dist_H_2_y', 'dist_H_3_y',
...
'dist_O_4_y', 'dist_F_0_y', 'dist_F_1_y', 'dist_F_2_y', 'dist_F_3_y',
'dist_F_4_y'
]
...
if True:
    ...
    coulomb_train = pd.read_csv("../processed/v003/coulomb_interaction_train.csv")
    coulomb_test = pd.read_csv("../processed/v003/coulomb_interaction_test.csv")
